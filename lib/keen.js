...
// if you put all your employees into a discourse group (recommended)
// put the ID of that group here
const EMPLOYEES_DISCOURSE_GROUP_ID = 41;
...
module.exports = {
  ...
  userForEvent: (apiResponse) => {
    ...
    if (EMPLOYEES_DISCOURSE_GROUP_ID) {
      baseUser.is_employee = typeof find(user.groups, { id: EMPLOYEES_DISCOURSE_GROUP_ID }) === 'object';
    }
    return baseUser;
  },
